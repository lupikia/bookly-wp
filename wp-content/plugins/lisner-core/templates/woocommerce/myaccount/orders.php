							...
							<?php elseif ( 'order-actions' === $column_id ) : ?>
								...
								if ( ! empty( $actions ) ) {
									foreach ( $actions as $key => $action ) {
										echo '<a href="' . esc_url( $action['url'] ) . '" class="listing-table-action ' . sanitize_html_class( $key ) . '" title="' . esc_html( $action['name'] ) . '"><i class="material-icons mf">' . esc_html( 'remove_red_eye' ) . '</i></a>';
									}
								}
								?>
							<?php endif; ?>
