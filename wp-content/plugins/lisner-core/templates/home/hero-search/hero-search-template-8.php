...
?>
<div class="hero-search hero-search-template-8 hero-search-template-big w-100" <?php echo esc_attr( $style ); ?>>
	<div class="container">
					...
					<div class="col-md-12">
						...
						<form id="search-form" action="<?php echo esc_url( get_permalink( $search_page ) ) ?>"
							...
							<div class="search-form-wrapper">
								...
								<div class="search-form-field-spacing"></div>
								<div class="search-form-field">
