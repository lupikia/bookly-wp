...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post">
	...
	<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
		<label for="account_first_name"><?php esc_html_e( 'First name', 'lisner' ); ?>&nbsp;<span
	...
	<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
		<label for="account_last_name"><?php esc_html_e( 'Last name', 'lisner' ); ?>&nbsp;<span
					class="required">*</span></label>
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
		<label for="account_display_name"><?php esc_html_e( 'Display name', 'lisner' ); ?>&nbsp;<span
					class="required">*</span></label>
		...
		<span><em><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'lisner' ); ?></em></span>
	</p>
	<div class="clear"></div>

	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
		<label for="account_email"><?php esc_html_e( 'Email address', 'lisner' ); ?>&nbsp;<span
					class="required">*</span></label>
	...
	<fieldset>
		<legend><?php esc_html_e( 'Password change', 'lisner' ); ?></legend>

		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			<label for="password_current"><?php esc_html_e( 'Current password (leave blank to leave unchanged)', 'lisner' ); ?></label>
		...
		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			<label for="password_1"><?php esc_html_e( 'New password (leave blank to leave unchanged)', 'lisner' ); ?></label>
		...
		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			<label for="password_2"><?php esc_html_e( 'Confirm new password', 'lisner' ); ?></label>
	...
	<p>
		<?php if ( ! pbs_is_demo() ) : ?>
			...
			<button type="submit" class="woocommerce-Button button" name="save_account_details"
			        value="<?php esc_attr_e( 'Save changes', 'lisner' ); ?>"><?php esc_html_e( 'Save changes', 'lisner' ); ?></button>
			<input type="hidden" name="action" value="save_account_details" />
		<?php else: ?>
		<button type="submit" class="btn btn-primary"
		        value="<?php esc_attr_e( 'Save address', 'lisner' ); ?>"
		        disabled="disabled"><?php esc_html_e( 'Save address', 'lisner' ); ?></button>
	<div class="d-flex mt-2"><?php esc_html_e( 'Disabled for demo purposes', 'lisner' ); ?></div>
<?php endif; ?>
	</p>
