...
?>
<div class="hero-search hero-search-template-3 hero-search-template-4 w-100" <?php echo esc_attr( $style ); ?>>
	<div class="container">
		...
		<div class="row align-items-end justify-content-center">
			<div class="col-9">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="hero-category-heading hero-category-style-3">
