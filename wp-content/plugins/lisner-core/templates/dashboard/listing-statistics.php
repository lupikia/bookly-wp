...
<?php if ( lisner_statistics::is_stat_enabled() ) : ?>
    <!-- Profile / Statistics -->
    <div class="profile-statistics-container">
        <h3 class="listing-stat-title"><?php printf( __( 'Statistics for: %s', 'lisner-core' ), '<span>' . get_the_title( $listing_id ) . '</span>' ); ?></h3>
        <div class="profile-statistics">
			...
			<?php if ( $focus_enabled ) : ?>
                ...
                <a href="javascript:" class="profile-statistic focus" data-stat="focus">
                    ...
                    <div class="profile-statistic--count">
                        <span><?php echo lisner_statistics::get_listing_stat( 'focus', $listing_id ); ?></span>
                    </div>
                </a>
			<?php endif; ?>
			...
			<?php if ( $ctr_enabled ) : ?>
                ...
                <a href="javascript:" class="profile-statistic ctr" data-stat="ctr">
                    ...
                    <div class="profile-statistic--count">
                        <span><?php echo esc_html( lisner_statistics::calculate_listing_ctr( $listing_id ) ); ?></span>
                    </div>
                </a>
			<?php endif; ?>
            ...
            <a href="javascript:" class="profile-statistic view" data-stat="view">
                ...
                <div class="profile-statistic--count">
                    <span><?php echo lisner_statistics::get_listing_stat( 'view', $listing_id ); ?></span>
                </div>
            </a>
            ...
            <a href="javascript:" class="profile-statistic lead" data-stat="lead">
                ...
                <div class="profile-statistic--count">
                    <span><?php echo lisner_statistics::get_listing_stat( 'lead', $listing_id ); ?></span>
                </div>
            </a>
            ...
            <a href="javascript:" class="profile-statistic review" data-stat="review">
                ...
                <div class="profile-statistic--count">
                    <span><?php echo lisner_statistics::get_listing_stat( 'review', $listing_id ); ?></span>
                </div>
            </a>
        </div>
        ...
        <div class="profile-charts-wrapper">
            ...
            <div id="user-chart" class="profile-charts" data-listing-id="<?php echo esc_attr( $listing_id ); ?>"></div>
        </div>
    </div>
<?php endif; ?>
