 ...
 */
class WC_Product_Job_Package extends pebas_paid_listings_listing_package_product {
	...
	public function is_sold_individually() {
		return apply_filters( 'pebas_paid_listings_' . $this->get_type() . '_is_sold_individually', true );
	}
	...
	public function add_to_cart_text() {
		$text = $this->is_purchasable() && $this->is_in_stock() ? __( 'Add to cart', 'pebas-paid-listings' ) : __( 'Read More', 'pebas-paid-listings' );
