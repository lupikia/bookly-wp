...
<div class="listing-package-wrapper <?php echo $distinctive ? esc_attr( 'listing-package-wrapper-distinctive' ) : ''; ?>">
    <div class="listing-package">
		...
		<?php endif; ?>
        <a href="javascript:"
           class="package-call btn btn-primary <?php echo $distinctive ? '' : esc_attr( 'btn-primary-bordered' ); ?>"><?php esc_html_e( 'Start now', 'pebas-paid-listings' ); ?></a>
