...
?>
<div class="hero-search hero-search-template-3 w-100" <?php echo esc_attr( $style ); ?>>
	<div class="container">
		...
		<div class="row align-items-end justify-content-center">
			<div class="col-9">
					...
					<div class="col-md-12">
						...
						<form id="search-form" action="<?php echo esc_url( get_permalink( $search_page ) ) ?>"
							...
							<div class="row row-cst-margin justify-content-center">
								...
								<div class="col-sm-3 col-cst-padding">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="hero-category-heading hero-category-style-2">
