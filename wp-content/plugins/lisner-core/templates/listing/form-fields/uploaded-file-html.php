<?php
if ( is_numeric( $value ) ) {
	$image_src = wp_get_attachment_image_src( absint( $value ), 'large' );
...
if ( in_array( $extension, array( 'jpg', 'gif', 'png', 'jpeg', 'jpe' ) ) ) : ?>
	<?php $image_src = job_manager_get_resized_image( $image_src, 'large' ) ?: $image_src; ?>
    <div class="job-manager-uploaded-file">
        <span class="job-manager-uploaded-file-preview"><img src="<?php echo esc_url( $image_src ); ?>"
                                                             class="img-style-1"/> <a
                    class="job-manager-remove-uploaded-file" href="#"><i
                        class="material-icons mf"><?php echo esc_html( 'remove_circle_outline' ); ?></i></a></span>
