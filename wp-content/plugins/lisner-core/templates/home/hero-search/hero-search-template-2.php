...
?>
<div class="hero-search hero-search-template-2" <?php echo esc_attr( $style ); ?>>
	<div class="container">
		<div class="row align-items-end">
			...
			<div class="col-lg-5">
				...
				<form id="search-form" class="shadowed" action="<?php echo esc_url( get_permalink( $search_page ) ) ?>"
				      method="get">
